...
**Input**: The argument after `/todos` is the change name (kebab-case), OR a description of what the user wants to build.
...
# 2. Create the change file to track the change

```bash
touch "TODOS.<name>.md"
```
This creates a placeholder for the file we are going to use to manage all our thinking/tasks/tracking in.
